...
if(isset($_POST['deconnexion'])){
    require('logoutAng.php');
}

if(isset($_POST['boitemssg'])){
    header('location:messagesAng.php');
}

if(isset($_POST['publieroffre'])){
    header('location:publierOffreAng.php');
}
if(isset($_POST['creermssg'])){
    header('location:creerMessageAng.php');
}
if(isset($_POST['mesOffre'])){
    header('location:mesOffresAng.php');
}
if(isset($_POST['mssgenvoyer'])){
    header('location:messagesEnvoyerAng.php');
}
if(isset($_POST['note'])){
    header('location:noteAng.php');
}
if(isset($_POST['mesNotes'])){
    header('location:mesNotesAng.php');
}

if(isset($_POST['profil'])){
    header('location:profileAng.php');
}

if(isset($_POST['trouver'])){
    header('location:scoreAng.php');
}

if(isset($_POST['ajout'])){
    header('location:infoRecruteurAng.php');
}
...
if(isset($_POST['btn-chercher'])){
    if(!empty($_POST['chercher'])){
        ...
        header('location:pageDeRechercheAng.php');
    }}
    ...
    header('location:score_rechercheAng.php');}
