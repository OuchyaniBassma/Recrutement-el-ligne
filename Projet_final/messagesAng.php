...
<div class="div1">
    ...
    <h1> Recruitment<span> $ Online </span></h1>
...
if($req->rowcount()==0){
    ...
    <div class="nv"><strong><i>Mailbox</i></strong></div>
    <form method="POST" action="">
    <table>
    <tr><td class="td1"><strong> Sender email :</strong></td><td class="td2"><strong>Messages :</strong></td><td class="td5"><strong>Send date :</strong></td></tr>
    <?php 
